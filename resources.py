...
from errors import AhaAuthError
    ...
    try:
        ...
        for release in releases:
            ...
            if status == "active":
                ...
                if release.get("parkingLot", False) or (release.get("releaseDate") and release["releaseDate"] < today):
                    continue
            # For "all" and "parking-lot", include everything from the query

            # Calculate feature statistics (runs for ALL releases, not just active)
            feature_stats = {
